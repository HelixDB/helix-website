          ...
          <div className="flex items-center w-full justify-between mb-6">
            ...
            <div className="flex items-center gap-4">
              ...
              <Button variant="outline" className="text-neutral-500" >
                <a href="https://helix.mintlify.app/introduction" target="_blank" rel="noopener noreferrer" >
                  Docs
                </a>
              </Button>
            </div>
            ...
            {activeView === "terminal" ? (
              <div className="space-y-4">
                ...
                >
                  ...
                  <pre className="p-4 font-mono text-sm overflow-auto max-h-[500px] overflow-auto">
                    {output}
                  </pre>
                </div>
              </div>
